...
slug: intellectual-property-and-ownership
...
You may have heard of concerns regarding plagiarism where AI is concerned. Sudowrite won't plagiarize unless you *force it* to plagiarize, which is against our Terms of Service.

AI works by guessing one word at a time, based on general concepts it has learned from billions of samples of text. That means it's *extremely unlikely* to produce the same words verbatim, or even ever again. It does not copy and paste chunks of text, it guesses each word—technically, *parts* of words—one at a time.
