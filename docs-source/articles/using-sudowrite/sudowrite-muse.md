---
title: "Sudowrite Muse"
slug: sudowrite-muse
category: using-sudowrite
imported_at: 2026-01-14T22:21:26.173Z
last_updated: 2026-01-14T22:21:26.173Z
source: notion
---
...
1. Basic AI writes boring emails. **Muse is just for fiction.**
...
2. Basic AI spews clichés. **Muse writes unique prose every single time.**
We specifically measure AI clichés during training and have systematically removed them from Muse’s output.
3. Basic AI loves happy endings. **Muse will write anything – no filters.**
...
![image.png](Sudowrite%20Muse/image.png)

![The model selector shows Muse as the default, with other models below.](Sudowrite%20Muse/image%201.png)
...
![Click the “Prose Mode” Dropdown in Write Settings to open the model selector for Write.](Sudowrite%20Muse/image%202.png)

Click the “Prose Mode” Dropdown in Write Settings to open the model selector for Write.

## Creativity

![image.png](Sudowrite%20Muse/image%203.png)
...
![CleanShot 2026-01-14 at 15.09.23@2x.png](Sudowrite%20Muse/CleanShot_2026-01-14_at_15.09.232x.png)
