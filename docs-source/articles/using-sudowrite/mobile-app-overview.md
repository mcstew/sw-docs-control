...
The Sudowrite mobile app is an **AI-powered writing assistant** **available for both iOS and Android** devices. It serves as a companion app to the full web app at sudowrite.com, allowing you to take your work on the go, maintain momentum, and capture fresh ideas wherever you are.
...
- You *can* write in Series projects
- You *can* access the Series bible of shared Character and Worldbuilding elements
