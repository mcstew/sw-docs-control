...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0f14]">
      <div className="max-w-sm w-full space-y-8 p-8 bg-gray-900 rounded-2xl border border-gray-800">
        <div className="text-center">
          <h1 className="text-2xl font-bold tracking-tight text-slate-100">
            Docs Control
          </h1>
          <p className="mt-2 text-sm text-gray-400">
            Sudowrite documentation orchestration
          </p>
        </div>
        ...
        <p className="text-xs text-center text-gray-500">
          Restricted to @sudowrite.com accounts
        </p>
      </div>
    </div>
  );
